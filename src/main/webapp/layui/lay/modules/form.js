                ...
                h = function(i, c, f) {
                    ...
                    if (!c) {
                        ...
                        var C = function(e, i, a) {
                        	e = pinyin.getCamelChars(e).toUpperCase();//把汉字转成拼音简写并转换成大写
                            var n = 0;
                            layui.each(g,
                            function() {
                                var i = t(this);
                                var l = pinyin.getCamelChars(i.text());
                                var r = l.indexOf(e) === -1; ("" === e || "blur" === a ? e !== l: r) && n++,
                        ...
                        w = function(e) {//下拉选模糊查询

                            var t = this.value,
                            i = e.keyCode;
 //                           gg = g;
//                            for(var aaa=0;aaa<gg.length;aaa++){
//                            	var p1 =  pinyin.getCamelChars($(gg[aaa]).text());
//                            	if(p1.indexOf(pinyin.getCamelChars(m[0].value))==-1){
//                            		$(gg[aaa]).remove();
//                            	}
//                            	
//                            }
